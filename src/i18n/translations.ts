      ...
      progress: {
        ...
        groups: {
          hsp: {
            ...
            items: [
              { before: 'Von Reizen überflutet', after: 'Überlastungssignale früher wahrnehmen', description: 'Oria hilft dir, feine Körpersignale zu erkennen, bevor die Überlastung einsetzt – durch regelmäßige Check-ins mit deinem Nervensystem.' },
              { before: 'Sensibilität als Schwäche', after: 'Sensibilität als Stärke erleben', description: 'Oria spiegelt dir, wie deine Wahrnehmungstiefe auch Ressource ist – nicht nur Last, sondern auch Zugang zu Nuancen, die anderen entgehen.' },
              { before: 'Grenzen schwer setzen', after: 'Nein sagen ohne Schuldgefühle', description: 'Durch das Verstehen deiner Bedürfnisse lernst du, Grenzen nicht als Ablehnung, sondern als Selbstfürsorge zu erleben.' },
              { before: 'Energieverlust', after: 'Bewusste Dosierung von Reizen', description: 'Oria macht sichtbar, welche Situationen Energie kosten und welche nähren – so kannst du bewusster wählen.' },
              { before: 'Körpersignale ignoriert', after: 'Den eigenen Signalen vertrauen', description: 'Regelmäßiger Kontakt mit deinem Körpererleben stärkt das Vertrauen in deine innere Weisheit.' },
            ],
          },
          crisis: {
            ...
            items: [
              ...
              { before: 'Innere Unruhe', after: 'Stabilität trotz äußerer Veränderung', description: 'Die regelmäßige Verbindung mit dir selbst wird zum inneren Anker, auch wenn außen alles in Bewegung ist.' },
            ],
          },
          therapy: {
          ...
          mindfulness: {
            ...
            items: [
              { before: 'Nur Beobachtung', after: 'Emotionale Tiefe und Integration', description: 'Oria ergänzt achtsames Beobachten um emotionales Verstehen – Gefühle werden nicht nur wahrgenommen, sondern eingeordnet.' },
              { before: 'Muster ohne Verstehen', after: 'Das "Warum" verstehen', description: 'Oria verbindet wiederkehrende Muster mit ihrer biografischen Bedeutung und macht sie dadurch veränderbar.' },
              { before: 'Gegenwart ohne Kontext', after: 'Biografische Verknüpfungen', description: 'Das Hier und Jetzt wird reicher, wenn es mit deiner Geschichte verbunden ist – Oria schafft diese Brücken.' },
              { before: 'Was fühle ich?', after: 'Was brauche ich wirklich?', description: 'Von der Wahrnehmung zur Bedürfniserkennung: Oria hilft dir, hinter dem Gefühl das dahinterliegende Bedürfnis zu entdecken.' },
              { before: 'Einsicht ohne Handlung', after: 'Von Einsicht zu Veränderung', description: 'Oria begleitet den Übergang von Erkenntnis zu verkörperter Veränderung im Alltag.' },
            ],
          },
          creative: {
            title: 'Kreative & Künstler',
            items: [
              { before: 'Kreative Blockaden', after: 'Zugang zu Inspirationsquellen', description: 'Oria hilft dir, den emotionalen Kern hinter Blockaden zu verstehen und wieder in den Fluss zu kommen.' },
              { before: 'Emotionen ungenutzt', after: 'Biografisches Material kreativ nutzen', description: 'Deine Erfahrungen und Gefühle werden zu kreativem Rohmaterial – Oria macht sie zugänglich und nutzbar.' },
              { before: 'Fremde Stimmen', after: 'Eigene authentische Stimme', description: 'Im Dialog mit Oria findest du heraus, was wirklich deine Stimme ist – jenseits von Erwartungen und Vergleichen.' },
              { before: 'Sich verlieren', after: 'Offen bleiben ohne Selbstverlust', description: 'Oria stärkt deine Verbindung zu dir selbst, sodass du dich öffnen kannst, ohne dich zu verlieren.' },
              { before: 'Erschöpfung', after: 'Kreativität und Selbstfürsorge vereinen', description: 'Kreatives Schaffen und Regeneration werden keine Gegensätze mehr – Oria hilft dir, beides zu integrieren.' },
            ],
          },
        },
        beforeLabel: 'Vorher',
