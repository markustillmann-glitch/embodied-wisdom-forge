export const translations = {
  de: {
    ...
    team: {
      ...
      disclaimer: '🔔 Hinweis: Dies ist eine Musterseite mit fiktiven Profilen zur Veranschaulichung. Die hier gezeigten Personen repräsentieren nicht das tatsächliche Team.',
      coaches: {
        title: 'Unsere Fachcoaches',
        subtitle: 'Jeder Programmblock wird von spezialisierten Experten durchgeführt',
        somatic: {
          name: 'Dr. Elena Berger',
          role: 'Somatic & Achtsamkeit',
          bio: 'Elena begleitet seit 15 Jahren Menschen auf ihrem Weg zu mehr Körperbewusstsein. Ihre Arbeit verbindet klassische Achtsamkeitspraxis mit modernen Erkenntnissen der Polyvagal-Theorie. "Der Körper vergisst nichts – aber er kann lernen, sich wieder sicher zu fühlen."',
          qualifications: 'Dipl.-Psychologin, MBSR-Lehrerin, Somatic Experiencing Practitioner',
        },
        ifs: {
          name: 'Michael Hartmann',
          role: 'IFS-Therapie',
          bio: 'Michael ist einer der wenigen zertifizierten IFS-Therapeuten im deutschsprachigen Raum. Mit seiner warmen, geduldigen Art schafft er Räume, in denen sich auch die scheuen inneren Anteile zeigen können. "Jeder Teil in uns hat einmal versucht zu helfen."',
          qualifications: 'IFS Level 3 Certified, Psychotherapeut (HP), Supervisor',
        },
        nvc: {
          name: 'Sarah Liebmann',
          role: 'Gewaltfreie Kommunikation',
          bio: 'Sarah bringt GFK aus dem Seminarraum in den Alltag. Ihre Workshops sind bekannt für lebendige Praxisübungen und den Mut, auch schwierige Themen anzusprechen. "Hinter jedem Vorwurf steckt ein unerfülltes Bedürfnis – auch bei mir selbst."',
          qualifications: 'Zertifizierte GFK-Trainerin (CNVC), Mediatorin, Organisationsberaterin',
        },
        bodywork: {
          name: 'Thomas Stein',
          role: 'Körperarbeit',
          bio: 'Thomas verbindet osteopathische Techniken mit traumasensiblem Arbeiten. In seinen Händen können sich auch tief gehaltene Spannungen lösen. "Der Körper trägt Geschichten, die der Kopf längst vergessen hat."',
          qualifications: 'Osteopath, Trauma-Release-Exercises Instructor, Craniosacral-Therapeut',
        },
        psychology: {
          name: 'Dr. Anna Richter',
          role: 'Psychologische Leitung',
          bio: 'Anna wacht über die psychologische Sicherheit aller Programme. Als erfahrene Psychotherapeutin erkennt sie früh, wenn jemand professionelle Unterstützung benötigt. "Selbstentwicklung darf herausfordernd sein – aber nie überfordernd."',
      ...
      support: {
        ...
        members: [
          { name: 'Lisa Kramer', role: 'Programm-Koordination' },
          { name: 'Jan Müller', role: 'Technische Betreuung' },
          { name: 'Marie Weber', role: 'Teilnehmer-Support' },
          { name: 'Felix Schmidt', role: 'Community Management' },
        ],
      },
      quality: {
    ...
    vault: {
      ...
      book: {
        ...
        openPdf: 'PDF öffnen',
        // Book type selection
        chooseBookType: 'Buchtyp wählen',
        chooseBookTypeDesc: 'Für wen soll dieses Erinnerungsbuch erstellt werden?',
        personalBook: 'Persönliches Buch',
        personalBookDesc: 'Ein Buch für dich selbst mit allen Details und Reflexionen.',
        giftBook: 'Geschenk-Buch',
        giftBookDesc: 'Ein Buch zum Verschenken an jemanden, der in dieser Erinnerung eine Rolle spielt.',
        recipientName: 'Für wen ist das Geschenk?',
        recipientNamePlaceholder: 'Name(n) der beschenkten Person(en)...',
        fromLabel: 'von',
        forLabel: 'für',
        giftDedication: 'Ich möchte Dir diese Erinnerung schenken, die mir sehr wichtig ist und mich mit Dir oder Euch verbindet.',
        yourName: 'Dein / Euer',
        createdOn: 'Erstellt am',
        continueBtn: 'Buch erstellen',
      },
      // Password protection
      ...
      // Deepen Ideas
      deepenTitle: 'Zum Vertiefen',
      deepenEmpty: 'Noch keine Ideen zum Vertiefen',
      deepenEmptyDesc: 'Sammle hier schnelle Gedanken und Themen, die du später erkunden möchtest.',
      deepenAddNew: 'Neue Idee',
      deepenTitlePlaceholder: 'Thema oder Gedanke...',
      deepenNotePlaceholder: 'Kurze Notiz (optional)...',
      deepenFromCoach: 'Von Oria',
      deepenFromManual: 'Manuell',
      deepenCompleted: 'Erledigt',
      deepenMarkComplete: 'Als erledigt markieren',
      deepenMarkIncomplete: 'Wieder öffnen',
      deepenDeleted: 'Idee gelöscht',
      deepenDeletedDesc: 'Die Idee wurde entfernt.',
      deepenSaved: 'Idee gespeichert',
      deepenSavedDesc: 'Deine Idee wurde hinzugefügt.',
      deepenError: 'Fehler beim Speichern der Idee.',
      deepenExplore: 'In Unterhaltung vertiefen',
    },
  ...
  en: {
    ...
    team: {
      ...
      disclaimer: '🔔 Note: This is a sample page with fictional profiles for illustration purposes. The people shown here do not represent the actual team.',
      coaches: {
        title: 'Our Expert Coaches',
        subtitle: 'Each program block is led by specialized experts',
        somatic: {
          name: 'Dr. Elena Berger',
          role: 'Somatic & Mindfulness',
          bio: 'Elena has been guiding people toward greater body awareness for 15 years. Her work combines classical mindfulness practice with modern insights from Polyvagal Theory. "The body forgets nothing—but it can learn to feel safe again."',
          qualifications: 'Clinical Psychologist, MBSR Teacher, Somatic Experiencing Practitioner',
        },
        ifs: {
          name: 'Michael Hartmann',
          role: 'IFS Therapy',
          bio: 'Michael is one of the few certified IFS therapists in the German-speaking region. With his warm, patient manner, he creates spaces where even shy inner parts can show themselves. "Every part within us once tried to help."',
          qualifications: 'IFS Level 3 Certified, Psychotherapist, Supervisor',
        },
        nvc: {
          name: 'Sarah Liebmann',
          role: 'Nonviolent Communication',
          bio: 'Sarah brings NVC from the seminar room into everyday life. Her workshops are known for lively practical exercises and the courage to address difficult topics. "Behind every criticism lies an unmet need—including my own."',
          qualifications: 'Certified NVC Trainer (CNVC), Mediator, Organizational Consultant',
        },
        bodywork: {
          name: 'Thomas Stein',
          role: 'Bodywork',
          bio: 'Thomas combines osteopathic techniques with trauma-sensitive work. In his hands, even deeply held tensions can release. "The body carries stories that the mind has long forgotten."',
          qualifications: 'Osteopath, Trauma Release Exercises Instructor, Craniosacral Therapist',
        },
        psychology: {
          name: 'Dr. Anna Richter',
      ...
      support: {
        ...
        subtitle: 'The people who keep everything running behind the scenes',
        members: [
          { name: 'Lisa Kramer', role: 'Program Coordination' },
          { name: 'Jan Müller', role: 'Technical Support' },
          { name: 'Marie Weber', role: 'Participant Support' },
          { name: 'Felix Schmidt', role: 'Community Management' },
        ],
      },
      quality: {
    ...
    vault: {
      ...
      book: {
        ...
        openPdf: 'Open PDF',
        // Book type selection
        chooseBookType: 'Choose Book Type',
        chooseBookTypeDesc: 'Who is this memory book for?',
        personalBook: 'Personal Book',
        personalBookDesc: 'A book for yourself with all details and reflections.',
        giftBook: 'Gift Book',
        giftBookDesc: 'A book to give to someone who plays a role in this memory.',
        recipientName: 'Who is the gift for?',
        recipientNamePlaceholder: 'Name(s) of recipient(s)...',
        fromLabel: 'from',
        forLabel: 'for',
        giftDedication: 'I want to gift you this memory, which is very important to me and connects me with you.',
        yourName: 'Yours',
        createdOn: 'Created on',
        continueBtn: 'Create Book',
      },
      // Password protection
      ...
      // Deepen Ideas
      deepenTitle: 'To Deepen',
      deepenEmpty: 'No ideas to deepen yet',
      deepenEmptyDesc: 'Collect quick thoughts and topics here that you want to explore later.',
      deepenAddNew: 'New Idea',
      deepenTitlePlaceholder: 'Topic or thought...',
      deepenNotePlaceholder: 'Short note (optional)...',
      deepenFromCoach: 'From Oria',
      deepenFromManual: 'Manual',
      deepenCompleted: 'Completed',
      deepenMarkComplete: 'Mark as complete',
      deepenMarkIncomplete: 'Reopen',
      deepenDeleted: 'Idea deleted',
      deepenDeletedDesc: 'The idea has been removed.',
      deepenSaved: 'Idea saved',
      deepenSavedDesc: 'Your idea has been added.',
      deepenError: 'Error saving idea.',
      deepenExplore: 'Explore in conversation',
    },
