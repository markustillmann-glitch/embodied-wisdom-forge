      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 text-foreground hover:text-accent transition-colors">
            ...
            <span className="font-serif text-lg hidden sm:inline">Inner Guidance</span>
          </Link>
        ...
        <div className="border-t border-chapter-divider">
          ...
          >
            ...
            >
              <p className="mb-4">
                {language === 'de'
                  ? 'Das Inner Guidance Through Lived Memories Inner Compass Framework basiert auf etablierten, wissenschaftlich fundierten Ansätzen und wird von Experten verschiedener Disziplinen validiert:'
                  : 'The Inner Guidance Through Lived Memories Inner Compass Framework is based on established, scientifically grounded approaches and is validated by experts from various disciplines:'}
              </p>
